...
Because an API may need to send different data based on the language of the user, mwapi provides a built-in strategy to handle the internationalization (i18n).
