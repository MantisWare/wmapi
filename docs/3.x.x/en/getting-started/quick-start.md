...
This action creates a new folder named `my-project` with the entire [files structure](../concepts/concepts.md#files-structure) of a mwapi application.
...
To create your first user, start your server (`mwapi start`) and go to : http://localhost:1337/admin.
...
To create your first API, start your server (`mwapi start`) and go to : http://localhost:1337/admin.
