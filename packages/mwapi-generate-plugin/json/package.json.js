...
module.exports = scope => {
  ...
  return _.merge(scope.appPackageJSON || {}, {
    ...
    'scripts': {
      ...
      'generate': 'node ./node_modules/plop/plop.js --plopfile node_modules/mwapi-helper-plugin/lib/internals/generators/index.js',
    ...
    'dependencies': {},
    'devDependencies': {
      'mwapi-helper-plugin': getDependencyVersion(cliPkg, 'mwapi')
    },
    'author': {
