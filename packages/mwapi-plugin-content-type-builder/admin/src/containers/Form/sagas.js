...
export function* editContentType(action) {
  try {
    ...
    mwapi.notification.error(get(error, ['response', 'payload', 'message'], 'notification.error'));
  }
}
...
export function* fetchConnections() {
  try {
    ...
    mwapi.notification.error('content-type-builder.notification.error.message');
  }
}
