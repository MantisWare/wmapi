          ...
          fs.readFile(sourcePath, (err, html) => {
            ...
            $('script').each(function(i, elem) {
              if ($(this).attr('src')) {
                ...
                const url = URL.parse(_.get(mwapi.config.currentEnvironment.server, 'admin.build.host', _.get(mwapi.config.currentEnvironment.server, 'admin.path', '/admin')));
            ...
            if (environment === 'production') {
              ...
              $('body').attr('front', `${_.get(mwapi.config.currentEnvironment.server, 'admin.path', '/admin')}`);
              $('body').attr('back', `/`);
            }
