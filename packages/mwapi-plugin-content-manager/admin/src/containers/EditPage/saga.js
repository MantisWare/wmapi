...
function* dataGet(action) {
  try {
    ...
    mwapi.notification.error('content-manager.error.record.fetch');
  }
}
...
export function* submit() {
  ...
  try {
    ...
    mwapi.notification.success('content-manager.success.record.save');
    ...
    mwapi.notification.error(isCreating ? 'content-manager.error.record.create' : 'content-manager.error.record.update');
  } finally {
