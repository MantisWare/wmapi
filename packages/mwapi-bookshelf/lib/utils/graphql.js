...
// mwapi helper for GraphQL.
const helpers = require('mwapi/lib/configuration/hooks/graphql/helpers/');
const utils = require('./');
...
module.exports = {
  ...
  create: (collectionIdentity, rootValue) => {
    return mwapi.services[collectionIdentity.toLowerCase()]
  ...
  update: (collectionIdentity, rootValue, args) => {
    ...
    const PK = utils.getPK(collectionIdentity.toLowerCase(), null, mwapi.models);
