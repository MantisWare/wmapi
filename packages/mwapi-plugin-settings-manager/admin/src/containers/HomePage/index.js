...
export class HomePage extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  handleSubmit = (e) => { // eslint-disable-line consistent-return
    ...
    if (isEmpty(body)) return mwapi.notification.info('settings-manager.mwapi.notification.info.settingsEqual');
    if (isEmpty(formErrors)) {
  ...
  handleSubmitEditDatabase = (databaseName) => { // eslint-disable-line consistent-return
    ...
    if (isEmpty(body)) {
      ...
      return mwapi.notification.info('settings-manager.mwapi.notification.info.settingsEqual');
    }
  ...
  handleDatabaseDelete = (dbName) => {
    ...
    mwapi.notification.success('settings-manager.mwapi.notification.success.databaseDelete');
