...
export function* editDatabase(action) {
  try {
    ...
    if (resp.ok) {
      mwapi.notification.success('settings-manager.mwapi.notification.success.databaseEdit');
    ...
    mwapi.notification.error('settings-manager.mwapi.notification.error');
  }
}
...
export function* deleteDatabase(action) {
  try {
    ...
    if (resp.ok) {
      ...
      mwapi.notification.success('settings-manager.mwapi.notification.success.databaseDeleted');
    }
  } catch(error) {
    yield call(action.context.disableGlobalOverlayBlocker);
...
export function* deleteLanguage(action) {
  try {
    ...
    if (resp.ok) {
      mwapi.notification.success('settings-manager.mwapi.notification.success.languageDelete');
    }
  } catch(error) {
...
export function* postLanguage() {
  try {
    ...
    if (resp.ok) {
      ...
      mwapi.notification.success('settings-manager.mwapi.notification.success.languageAdd');
    }
  } catch(error) {
    yield put(languageActionError());
    mwapi.notification.error('settings-manager.mwapi.notification.error');
...
export function* postDatabase(action) {
  try {
    ...
    if (resp.ok) {
      yield put(databaseActionSucceeded());
      mwapi.notification.success('settings-manager.mwapi.notification.success.databaseAdd');
    }
  } catch(error) {
...
export function* settingsEdit(action) {
  try {
    ...
    if (resp.ok) {
      ...
      mwapi.notification.success('settings-manager.mwapi.notification.success.settingsEdit');
    }
  } catch(error) {
    mwapi.notification.error('settings-manager.mwapi.notification.error');
  } finally {
